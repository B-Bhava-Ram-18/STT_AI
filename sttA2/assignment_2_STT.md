...
1. **Label Studio Setup:**  
   ...
   * Import the provided [movie\_reviews\_300.csv](https://drive.google.com/file/d/1EpvTWgBSGrXjJl24WQqkRrQ3PyuP_cj6/view?usp=sharing).  
   * Choose an NLP template task named “Text Classification”. Write an XML config such that the available labels are (single choice): Positive, Negative, and Neutral, and the review texts come from the review column in [movie\_reviews\_300.csv](https://drive.google.com/file/d/1EpvTWgBSGrXjJl24WQqkRrQ3PyuP_cj6/view?usp=sharing). You can do this directly in the GUI (do not change the column names in your provided CSV).  
